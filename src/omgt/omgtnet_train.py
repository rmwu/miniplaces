"""
Neural network model for 6.869 MiniPlaces Challenge,
for the fall 2017 semester.

Menghua Wu, Laura Pang
"""
...
step_display = 50
step_save = 10000
path_save = 'model_omgt'
start_from = ''

def model_omgt(x, keep_dropout):
    """
    Neural network with [insert stuff here]
    """
...
# Construct model
logits = model_omgt(x, keep_dropout)
